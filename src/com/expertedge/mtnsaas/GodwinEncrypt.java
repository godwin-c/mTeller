 ...
 * @author agada
 */
public final class GodwinEncrypt {
    ...
    /**
     * Initialize GodwinEncrypt internal state (object can be reused just by calling
     ...
     * initialization
     */
    public GodwinEncrypt(Object ob) {
        this();
        Update(ob.toString());
    }
